...
beforeEach(() => {
  SubscribeService.subscribe = vi.fn();
});
      ...
      order: {
        ...
        items: [{
          ...
          descriptor: {
            name: 'SUV',
            code: 'SUV_TAXI',
            images: ['https://cdn.iconscout.com/icon/premium/png-256-thumb/taxi-2716987-2254385.png'],
          },
          price: {
            currency: 'INR',
            value: '1411',
        ...
        fulfillment: {
          tracking: false,
          start: {
            location: { gps: '9.9312328, 76.2673041' },
            time: { timestamp: '2023-03-27T11:51:13.366Z' },
          },
...
describe('Subscribe Controller', () => {
  it('should test status service is called', async () => {
    ...
    await SubscribeController.subscribe(request, res);
    expect(SubscribeService.subscribe)
      .toBeCalled();
  });
